<template>
    <div class="main-content">
        <el-dialog title="帖子回复详情" :visible.sync="forumReplyDialogVisible">
            <el-dialog width="30%" :title="forumReplyInfoContent" :visible.sync="forumReplyInfoDialogVisible"
                append-to-body>
            </el-dialog>
            <div class="demo-input-suffix">
                <span style="width: 20%">帖子标题：</span><el-input v-model="forumTitle" :disabled="true" placeholder="帖子标题"
                    style="width: 80%"></el-input>
            </div>
            <div class="demo-input-suffix">
                <span style="width: 20%">帖子内容：</span><el-input v-model="forumContent" :disabled="true"
                    placeholder="帖子内容" style="width: 80%" type="textarea"></el-input>
            </div>
            <el-table :data="forumData" height="250">
                ...
                <el-table-column property="caozuo" label="操作">
                    <template slot-scope="scope">
                        ...
                        <el-button v-if="isAuth('forum', '删除') && role == '管理员'" type="danger"
                            @click="deleteForumData(scope.row.id)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <div class="demo-input-suffix">
        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                ...
                <el-row class="ad"
                    ...
                    <el-form-item>
                        <el-button v-if="isAuth('forum', '新增')" type="success" icon="el-icon-plus"
                            @click="addOrUpdateHandler()">新增</el-button>
                        &nbsp;
                        <el-button v-if="isAuth('forum', '删除')" :disabled="dataListSelections.length <= 0" type="danger"
                            icon="el-icon-delete" @click="deleteHandler()">删除</el-button>
                        &nbsp;
                        <el-button v-if="isAuth('forum', '报表')" type="success" icon="el-icon-pie-chart"
                            @click="chartDialog()">报表</el-button>
                        &nbsp;
                        <a style="text-decoration:none" class="el-button el-button--success"
                            v-if="isAuth('forum', '导入导出')" icon="el-icon-download"
                        ...
                        &nbsp;
                        <!-- 导出excel -->
                        <download-excel v-if="isAuth('forum', '导入导出')" style="display: inline-block"
                            class="export-excel-wrapper" :data="dataList" :fields="json_fields" name="forum.xls">
                            <!-- 导出excel -->
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    v-if="isAuth('forum', '查看')" :data="dataList" v-loading="dataListLoading"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="forumName"
                        header-align="center" label="帖子标题">
                        <template slot-scope="scope">
                            {{ scope.row.forumName }}
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="insertTime"
                        header-align="center" label="发帖时间">
                        <template slot-scope="scope">
                    ...
                    <el-table-column width="300" :align="contents.tableAlign" header-align="center" label="操作">
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('forum', '查看')" type="primary" icon="el-icon-edit" size="mini"
                                @click="openReplyForum(scope.row.id, scope.row.forumName, scope.row.forumContent)">查看论坛回复</el-button>
                            ...
                            <el-button v-if="isAuth('forum', '删除')" type="danger" icon="el-icon-delete" size="mini"

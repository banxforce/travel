        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt"
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '动态标题' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.lvyoudongtaiName" placeholder="动态标题"
                            clearable></el-input>
                    </el-form-item>
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '动态类型' : ''">
                        <el-select v-model="searchForm.lvyoudongtaiTypes" placeholder="请选择动态类型">
                            ...
                            <el-option v-for="(item, index) in lvyoudongtaiTypesSelectSearch" v-bind:key="index"
                ...
                <el-row class="ad"
                    ...
                    <el-form-item>
                        <el-button v-if="isAuth('lvyoudongtai', '新增')" type="success" icon="el-icon-plus"
                            @click="addOrUpdateHandler()">新增</el-button>
                        &nbsp;
                        <el-button v-if="isAuth('lvyoudongtai', '删除')" :disabled="dataListSelections.length <= 0"
                            type="danger" icon="el-icon-delete" @click="deleteHandler()">删除</el-button>
                        &nbsp;
                        <el-button v-if="isAuth('lvyoudongtai', '报表')" type="success" icon="el-icon-pie-chart"
                            @click="chartDialog()">报表</el-button>
                        &nbsp;
                        <a style="text-decoration:none" class="el-button el-button--success"
                            v-if="isAuth('lvyoudongtai', '导入导出')" icon="el-icon-download"
                        ...
                        &nbsp;
                        <!-- 导出excel -->
                        <download-excel v-if="isAuth('lvyoudongtai', '导入导出')" style="display: inline-block"
                            class="export-excel-wrapper" :data="dataList" :fields="json_fields" name="lvyoudongtai.xls">
                            <!-- 导出excel -->
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    v-if="isAuth('lvyoudongtai', '查看')" :data="dataList" v-loading="dataListLoading"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                        prop="lvyoudongtaiName" header-align="center" label="动态标题">
                        <template slot-scope="scope">
                            {{ scope.row.lvyoudongtaiName }}
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                        prop="lvyoudongtaiTypes" header-align="center" label="动态类型">
                        <template slot-scope="scope">
                            {{ scope.row.lvyoudongtaiValue }}
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                        prop="lvyoudongtaiPhoto" header-align="center" width="200" label="动态图片">
                        <template slot-scope="scope">

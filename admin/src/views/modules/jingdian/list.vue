        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt"
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '景点名称' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.jingdianName" placeholder="景点名称"
                            clearable></el-input>
                    </el-form-item>
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '景点类型' : ''">
                        <el-select v-model="searchForm.jingdianTypes" placeholder="请选择景点类型">
                            ...
                            <el-option v-for="(item, index) in jingdianTypesSelectSearch" v-bind:key="index"
                ...
                <el-row class="ad"
                    ...
                    <el-form-item>
                        <el-button v-if="isAuth('jingdian', '新增')" type="success" icon="el-icon-plus"
                            @click="addOrUpdateHandler()">新增</el-button>
                        &nbsp;
                        <el-button v-if="isAuth('jingdian', '删除')" :disabled="dataListSelections.length <= 0"
                            type="danger" icon="el-icon-delete" @click="deleteHandler()">删除</el-button>
                        &nbsp;
                        <el-button v-if="isAuth('jingdian', '报表')" type="success" icon="el-icon-pie-chart"
                            @click="chartDialog()">报表</el-button>
                        &nbsp;
                        <a style="text-decoration:none" class="el-button el-button--success"
                            v-if="isAuth('jingdian', '导入导出')" icon="el-icon-download"
                        ...
                        &nbsp;
                        <!-- 导出excel -->
                        <download-excel v-if="isAuth('jingdian', '导入导出')" style="display: inline-block"
                            class="export-excel-wrapper" :data="dataList" :fields="json_fields" name="jingdian.xls">
                            <!-- 导出excel -->
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    v-if="isAuth('jingdian', '查看')" :data="dataList" v-loading="dataListLoading"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="jingdianName"
                        header-align="center" label="景点名称">
                        <template slot-scope="scope">
                            {{ scope.row.jingdianName }}
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                        prop="jingdianTypes" header-align="center" label="景点类型">
                        <template slot-scope="scope">
                            {{ scope.row.jingdianValue }}
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                        prop="jingdianPhoto" header-align="center" width="200" label="景点图片">
                        <template slot-scope="scope">
                    ...
                    <el-table-column width="300" :align="contents.tableAlign" header-align="center" label="操作">
                        <template slot-scope="scope">
                            <el-button v-if="isAuth('jingdian', '查看')" type="success" icon="el-icon-tickets" size="mini"
                                @click="addOrUpdateHandler(scope.row.id, 'info')">详情</el-button>
                            <el-button v-if="isAuth('jingdian', '修改')" type="primary" icon="el-icon-edit" size="mini"
                                @click="addOrUpdateHandler(scope.row.id)">修改</el-button>
                            <el-button v-if="isAuth('jingdian', '删除')" type="danger" icon="el-icon-delete" size="mini"
...
.tables {
    & /deep/ .el-button--success {
        ...
        border-color: #DCDFE6;
        border-radius: 6px;
        background-color: rgba(253, 199, 90, 0.54);
    }
    ...
    & /deep/ .el-button--primary {
        ...
        border-color: #DCDFE6;
        border-radius: 6px;
        background-color: rgba(217, 255, 128, 0.65);
    }

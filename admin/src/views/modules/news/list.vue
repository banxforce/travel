        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt"
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '公告标题' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.newsName" placeholder="公告标题"
                            clearable></el-input>
                    </el-form-item>
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '公告类型' : ''">
                        <el-select v-model="searchForm.newsTypes" placeholder="请选择公告类型">
                            ...
                            <el-option v-for="(item, index) in newsTypesSelectSearch" v-bind:key="index"
                ...
                <el-row class="ad"
                    ...
                    <el-form-item>
                        <el-button v-if="isAuth('news', '新增')" type="success" icon="el-icon-plus"
                            @click="addOrUpdateHandler()">新增</el-button>
                        &nbsp;
                        <el-button v-if="isAuth('news', '删除')" :disabled="dataListSelections.length <= 0" type="danger"
                            icon="el-icon-delete" @click="deleteHandler()">删除</el-button>
                        &nbsp;
                        <el-button v-if="isAuth('news', '报表')" type="success" icon="el-icon-pie-chart"
                            @click="chartDialog()">报表</el-button>
                        &nbsp;
                        <a style="text-decoration:none" class="el-button el-button--success"
                            v-if="isAuth('news', '导入导出')" icon="el-icon-download"
                        ...
                        &nbsp;
                        <!-- 导出excel -->
                        <download-excel v-if="isAuth('news', '导入导出')" style="display: inline-block"
                            class="export-excel-wrapper" :data="dataList" :fields="json_fields" name="news.xls">
                            <!-- 导出excel -->
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    v-if="isAuth('news', '查看')" :data="dataList" v-loading="dataListLoading"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="newsName"
                        header-align="center" label="公告标题">
                        <template slot-scope="scope">
                            {{ scope.row.newsName }}
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="newsTypes"
                        header-align="center" label="公告类型">
                        <template slot-scope="scope">
                            {{ scope.row.newsValue }}
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="newsPhoto"
                        header-align="center" width="200" label="公告图片">
                        <template slot-scope="scope">
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="insertTime"
                        header-align="center" label="公告时间">
                        <template slot-scope="scope">
